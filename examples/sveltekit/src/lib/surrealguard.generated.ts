...
declare module "@surrealguard/client" {
  interface SurqlRegistry {
    "SELECT id, name, age, team FROM person WHERE age > $__host0": { result: [Array<{ age: number; id: RecordId<"person">; name: string; team: RecordId<"team"> }>]; params: Record<string, never> };
    ...
    "SELECT id, name, age, team FROM person WHERE age > ${}": { result: [Array<{ age: number; id: RecordId<"person">; name: string; team: RecordId<"team"> }>]; params: Record<string, never> };
  }
}
