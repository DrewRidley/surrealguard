...
by [SurrealGuard](https://github.com/DrewRidley/surrealguard).
...
at commit `f40a0ede750081b8d49feb40516c28cc49f1cce4`. SurrealGuard maintains the
...
**`surrealguard-tree-sitter-surrealql`**. The library keeps the conventional
